...
@AnalyzeClasses(packagesOf = BlogapiApp.class, importOptions = DoNotIncludeTests.class)
class TechnicalStructureTest {
  ...
  static final ArchRule respectsTechnicalArchitectureLayers =
      layeredArchitecture()
          ...
          .ignoreDependency(belongToAnyOf(BlogapiApp.class), alwaysTrue())
          .ignoreDependency(
              alwaysTrue(),
              belongToAnyOf(
                  me.lnkkerst.webblogapi.config.Constants.class,
                  me.lnkkerst.webblogapi.config.ApplicationProperties.class));
}
