...
import me.lnkkerst.webblogapi.config.Constants;
import me.lnkkerst.webblogapi.domain.User;
import me.lnkkerst.webblogapi.repository.AuthorityRepository;
import me.lnkkerst.webblogapi.repository.UserRepository;
import me.lnkkerst.webblogapi.security.AuthoritiesConstants;
import me.lnkkerst.webblogapi.service.UserService;
import me.lnkkerst.webblogapi.service.dto.AdminUserDTO;
import me.lnkkerst.webblogapi.service.dto.PasswordChangeDTO;
import me.lnkkerst.webblogapi.web.rest.vm.KeyAndPasswordVM;
import me.lnkkerst.webblogapi.web.rest.vm.ManagedUserVM;
...
class AccountResourceIT {
  ...
  void testAuthenticatedUser() throws Exception {
    restAccountMockMvc
        .perform(
            get("/api/authenticate").with(request -> request).accept(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk())
