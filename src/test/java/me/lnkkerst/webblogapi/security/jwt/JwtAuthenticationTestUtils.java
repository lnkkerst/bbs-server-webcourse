package me.lnkkerst.webblogapi.security.jwt;

import static me.lnkkerst.webblogapi.security.SecurityUtils.AUTHORITIES_KEY;
import static me.lnkkerst.webblogapi.security.SecurityUtils.JWT_ALGORITHM;
...
public class JwtAuthenticationTestUtils {
  ...
  public static String createValidTokenForUser(String jwtKey, String user) {
    ...
    JwtClaimsSet claims =
        JwtClaimsSet.builder()
            ...
            .claims(
                customClain ->
                    customClain.put(AUTHORITIES_KEY, Collections.singletonList("ROLE_ADMIN")))
            .build();
  ...
  public static String createTokenWithDifferentSignature() {
    ...
    JwtClaimsSet claims =
        JwtClaimsSet.builder().issuedAt(now).expiresAt(past).subject("anonymous").build();
