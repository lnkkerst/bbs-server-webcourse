...
import me.lnkkerst.webblogapi.security.*;
        ...
        .authorizeHttpRequests(
            authz ->
                ...
                authz
                    ...
                    .permitAll()
                    .requestMatchers(mvc.pattern(HttpMethod.GET, "/api/users/**"))
                    .permitAll()
                    .requestMatchers(mvc.pattern(HttpMethod.GET, "/api/users/**"))
                    .permitAll()
                    .requestMatchers(mvc.pattern(HttpMethod.GET, "/api/nodes/**"))
                    .permitAll()
                    .requestMatchers(mvc.pattern(HttpMethod.GET, "/api/favorites/**"))
                    .permitAll()
                    .requestMatchers(mvc.pattern(HttpMethod.GET, "/api/posts/**"))
                    .permitAll()
