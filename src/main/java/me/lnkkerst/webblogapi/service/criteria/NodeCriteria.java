...
/**
 * Criteria class for the {@link me.lnkkerst.webblogapi.domain.Node} entity. This class is used in
 * {@link me.lnkkerst.webblogapi.web.rest.NodeResource} to receive all the possible filtering
 * options from the Http GET request parameters. For example the following could be a valid request:
 * {@code /nodes?id.greaterThan=5&attr1.contains=something&attr2.specified=false} As Spring is
